...
data class WatchHistoryDto(val contentId: String, val title: String = "", val poster: String? = null, val positionMs: Long = 0, val durationMs: Long = 0, val completed: Boolean = false, val updatedAt: Long = 0, val seriesId: String? = null)
data class PairingCreateDto(val code: String = "", val expiresInSeconds: Int = 0)
data class PairingRedeemDto(val code: String)
